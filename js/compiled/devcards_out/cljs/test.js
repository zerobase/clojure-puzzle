...
var args37961 = [];
var len__20609__auto___37965 = arguments.length;
var i__20610__auto___37966 = (0);
while(true){
if((i__20610__auto___37966 < len__20609__auto___37965)){
args37961.push((arguments[i__20610__auto___37966]));

var G__37967 = (i__20610__auto___37966 + (1));
i__20610__auto___37966 = G__37967;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args37961.length)].join('')));
...
var G__37964 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
var G__37964__$1 = ((cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter))?cljs.core.assoc.call(null,G__37964,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint):G__37964);
return G__37964__$1;
});
...
var or__19551__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__20609__auto___37972 = arguments.length;
var i__20610__auto___37973 = (0);
while(true){
if((i__20610__auto___37973 < len__20609__auto___37972)){
args__20616__auto__.push((arguments[i__20610__auto___37973]));

var G__37974 = (i__20610__auto___37973 + (1));
i__20610__auto___37973 = G__37974;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__20617__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq37969){
var G__37970 = cljs.core.first.call(null,seq37969);
var seq37969__$1 = cljs.core.next.call(null,seq37969);
var G__37971 = cljs.core.first.call(null,seq37969__$1);
var seq37969__$2 = cljs.core.next.call(null,seq37969__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__37970,G__37971,seq37969__$2);
});
...
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__37978,map__37978__$1,file,line,column){
return (function (p1__37975_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__37975_SHARP_));
});})(map__37978,map__37978__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__20464__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__20464__auto__,prefer_table__20465__auto__,method_cache__20466__auto__,cached_hierarchy__20467__auto__,hierarchy__20468__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__19551__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__19551__auto__)){
return or__19551__auto__;
} else {
...
var temp__4425__auto___37980 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___37980)){
var message_37981 = temp__4425__auto___37980;
cljs.core.println.call(null,message_37981);
} else {
}
...
var temp__4425__auto___37982 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___37982)){
var message_37983 = temp__4425__auto___37982;
cljs.core.println.call(null,message_37983);
} else {
}
...
var temp__4423__auto__ = (function (){var and__19539__auto__ = typeof exception.stack === 'string';
if(and__19539__auto__){
var G__37989 = exception.stack;
var G__37989__$1 = (((G__37989 == null))?null:clojure.string.split_lines.call(null,G__37989));
var G__37989__$2 = (((G__37989__$1 == null))?null:cljs.core.get.call(null,G__37989__$1,depth));
var G__37989__$3 = (((G__37989__$2 == null))?null:clojure.string.trim.call(null,G__37989__$2));
return G__37989__$3;
} else {
...
var vec__37990 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__37990,(0),null);
var column = cljs.core.nth.call(null,vec__37990,(1),null);
var vec__37991 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__37991,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__37991,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__37991,(2),null);
...
var m__$1 = (function (){var G__37993 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__37993) {
case "fail":
...
var G__37999 = (function (){var G__37998 = cljs.core.rest.call(null,fns);
var G__37998__$1 = (cljs.core.truth_(new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,obj)))?cljs.core.concat.call(null,obj,G__37998):G__37998);
return G__37998__$1;
})();
fns = G__37999;
continue;
...
var G__38001 = fns;
var G__38001__$1 = (((G__38001 == null))?null:cljs.core.vary_meta.call(null,G__38001,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true));
return G__38001__$1;
});
...
var G__38005 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__38005) {
...
var vec__38008 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__38008,(0),null);
var types = vec__38008;
...
return cljs.core.map.call(null,(function (p__38016){
var vec__38017 = p__38016;
var ns = cljs.core.nth.call(null,vec__38017,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__38017,(1),null);
return ((function (vec__38017,ns,vars__$1){
return (function (){
...
var G__38018 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__38018) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__38018,env,once_fixtures,each_fixtures,vec__38017,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__38018,env,once_fixtures,each_fixtures,vec__38017,ns,vars__$1){
return (function (){
var seq__38019 = cljs.core.seq.call(null,vars__$1);
var chunk__38020 = null;
var count__38021 = (0);
var i__38022 = (0);
while(true){
if((i__38022 < count__38021)){
var v = cljs.core._nth.call(null,chunk__38020,i__38022);
var temp__4425__auto___38024 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___38024)){
var t_38025 = temp__4425__auto___38024;
each_fixture_fn.call(null,((function (seq__38019,chunk__38020,count__38021,i__38022,t_38025,temp__4425__auto___38024,v,each_fixture_fn,G__38018,env,once_fixtures,each_fixtures,vec__38017,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_38025)));
});})(seq__38019,chunk__38020,count__38021,i__38022,t_38025,temp__4425__auto___38024,v,each_fixture_fn,G__38018,env,once_fixtures,each_fixtures,vec__38017,ns,vars__$1))
);
} else {
}

var G__38026 = seq__38019;
var G__38027 = chunk__38020;
var G__38028 = count__38021;
var G__38029 = (i__38022 + (1));
seq__38019 = G__38026;
chunk__38020 = G__38027;
count__38021 = G__38028;
i__38022 = G__38029;
continue;
} else {
var temp__4425__auto__ = cljs.core.seq.call(null,seq__38019);
if(temp__4425__auto__){
var seq__38019__$1 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__38019__$1)){
var c__20354__auto__ = cljs.core.chunk_first.call(null,seq__38019__$1);
var G__38030 = cljs.core.chunk_rest.call(null,seq__38019__$1);
var G__38031 = c__20354__auto__;
var G__38032 = cljs.core.count.call(null,c__20354__auto__);
var G__38033 = (0);
seq__38019 = G__38030;
chunk__38020 = G__38031;
count__38021 = G__38032;
i__38022 = G__38033;
continue;
} else {
var v = cljs.core.first.call(null,seq__38019__$1);
var temp__4425__auto___38034__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___38034__$1)){
var t_38035 = temp__4425__auto___38034__$1;
each_fixture_fn.call(null,((function (seq__38019,chunk__38020,count__38021,i__38022,t_38035,temp__4425__auto___38034__$1,v,seq__38019__$1,temp__4425__auto__,each_fixture_fn,G__38018,env,once_fixtures,each_fixtures,vec__38017,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_38035)));
});})(seq__38019,chunk__38020,count__38021,i__38022,t_38035,temp__4425__auto___38034__$1,v,seq__38019__$1,temp__4425__auto__,each_fixture_fn,G__38018,env,once_fixtures,each_fixtures,vec__38017,ns,vars__$1))
);
} else {
}

var G__38036 = cljs.core.next.call(null,seq__38019__$1);
var G__38037 = null;
var G__38038 = (0);
var G__38039 = (0);
seq__38019 = G__38036;
chunk__38020 = G__38037;
count__38021 = G__38038;
i__38022 = G__38039;
continue;
}
} else {
...
});})(each_fixture_fn,G__38018,env,once_fixtures,each_fixtures,vec__38017,ns,vars__$1))
);
});})(each_fixture_fn,G__38018,env,once_fixtures,each_fixtures,vec__38017,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1458632001391