...
var len__20608__auto___25759 = arguments.length;
var i__20609__auto___25760 = (0);
while(true){
if((i__20609__auto___25760 < len__20608__auto___25759)){
args__20615__auto__.push((arguments[i__20609__auto___25760]));

var G__25761 = (i__20609__auto___25760 + (1));
i__20609__auto___25760 = G__25761;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq25758){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq25758));
});
/**
...
var vec__25763 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__25763,(0),null);
var words = cljs.core.nthnext.call(null,vec__25763,(1));
...
var G__25765 = clojure.set.rename_keys.call(null,m,kmap);
var G__25765__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__25765,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__25765);
return G__25765__$1;
} else {
return m;
}
...
//# sourceMappingURL=util.js.map?rel=1457335559566