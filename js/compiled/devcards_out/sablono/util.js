...
var m__20206__auto__ = (sablono.util.to_str[goog.typeOf(x__20205__auto__)]);
if(!((m__20206__auto__ == null))){
return m__20206__auto__.call(null,x);
} else {
var m__20206__auto____$1 = (sablono.util.to_str["_"]);
...
var x__20205__auto__ = (((x == null))?null:x);
var m__20206__auto__ = (sablono.util.to_uri[goog.typeOf(x__20205__auto__)]);
if(!((m__20206__auto__ == null))){
return m__20206__auto__.call(null,x);
} else {
var m__20206__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__20206__auto____$1 == null))){
return m__20206__auto____$1.call(null,x);
} else {
...
var len__20608__auto___27356 = arguments.length;
var i__20609__auto___27357 = (0);
while(true){
if((i__20609__auto___27357 < len__20608__auto___27356)){
args__20615__auto__.push((arguments[i__20609__auto___27357]));

var G__27358 = (i__20609__auto___27357 + (1));
i__20609__auto___27357 = G__27358;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__20616__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq27355){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq27355));
});
/**
...
var vec__27360 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__27360,(0),null);
var words = cljs.core.nthnext.call(null,vec__27360,(1));
...
var G__27362 = clojure.set.rename_keys.call(null,m,kmap);
var G__27362__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__27362,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__27362);
return G__27362__$1;
} else {
return m;
}
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__19550__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1457514249557